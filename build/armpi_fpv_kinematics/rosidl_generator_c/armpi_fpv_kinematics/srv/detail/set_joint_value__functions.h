...
#ifndef ARMPI_FPV_KINEMATICS__SRV__DETAIL__SET_JOINT_VALUE__FUNCTIONS_H_
#define ARMPI_FPV_KINEMATICS__SRV__DETAIL__SET_JOINT_VALUE__FUNCTIONS_H_
...
/// Initialize srv/SetJointValue message.
/**
 ...
 * )) before or use
 * armpi_fpv_kinematics__srv__SetJointValue_Request__create()
...
/// Finalize srv/SetJointValue message.
/**
...
/// Create srv/SetJointValue message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * armpi_fpv_kinematics__srv__SetJointValue_Request__init().
...
/// Destroy srv/SetJointValue message.
/**
 * It calls
 * armpi_fpv_kinematics__srv__SetJointValue_Request__fini()
...
/// Check for srv/SetJointValue message equality.
/**
...
/// Copy a srv/SetJointValue message.
/**
...
/// Initialize array of srv/SetJointValue messages.
/**
...
/// Finalize array of srv/SetJointValue messages.
/**
 * It calls
 * armpi_fpv_kinematics__srv__SetJointValue_Request__fini()
...
/// Create array of srv/SetJointValue messages.
/**
 * It allocates the memory for the array and calls
 * armpi_fpv_kinematics__srv__SetJointValue_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetJointValue messages.
/**
 * It calls
 * armpi_fpv_kinematics__srv__SetJointValue_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetJointValue message array equality.
/**
...
/// Copy an array of srv/SetJointValue messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * armpi_fpv_kinematics__srv__SetJointValue_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_armpi_fpv_kinematics
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * armpi_fpv_kinematics__srv__SetJointValue_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_armpi_fpv_kinematics
...
/**
 * It calls
 * armpi_fpv_kinematics__srv__SetJointValue_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_armpi_fpv_kinematics
...
/**
 * It allocates the memory for the array and calls
 * armpi_fpv_kinematics__srv__SetJointValue_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_armpi_fpv_kinematics
...
/**
 * It calls
 * armpi_fpv_kinematics__srv__SetJointValue_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * armpi_fpv_kinematics__srv__SetJointValue_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_armpi_fpv_kinematics
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * armpi_fpv_kinematics__srv__SetJointValue_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_armpi_fpv_kinematics
...
/**
 * It calls
 * armpi_fpv_kinematics__srv__SetJointValue_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_armpi_fpv_kinematics
...
/**
 * It allocates the memory for the array and calls
 * armpi_fpv_kinematics__srv__SetJointValue_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_armpi_fpv_kinematics
...
/**
 * It calls
 * armpi_fpv_kinematics__srv__SetJointValue_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ARMPI_FPV_KINEMATICS__SRV__DETAIL__SET_JOINT_VALUE__FUNCTIONS_H_
