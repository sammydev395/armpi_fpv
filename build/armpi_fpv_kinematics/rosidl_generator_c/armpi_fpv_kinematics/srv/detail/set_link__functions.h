...
#ifndef ARMPI_FPV_KINEMATICS__SRV__DETAIL__SET_LINK__FUNCTIONS_H_
#define ARMPI_FPV_KINEMATICS__SRV__DETAIL__SET_LINK__FUNCTIONS_H_
 ...
 * )) before or use
 * armpi_fpv_kinematics__srv__SetLink_Request__create()
 ...
 * calls
 * armpi_fpv_kinematics__srv__SetLink_Request__init().
...
/**
 * It calls
 * armpi_fpv_kinematics__srv__SetLink_Request__fini()
 ...
 * armpi_fpv_kinematics__srv__SetLink_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * armpi_fpv_kinematics__srv__SetLink_Request__Sequence__fini()
 * on the array,
 ...
 * )) before or use
 * armpi_fpv_kinematics__srv__SetLink_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_armpi_fpv_kinematics
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * armpi_fpv_kinematics__srv__SetLink_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_armpi_fpv_kinematics
...
/**
 * It calls
 * armpi_fpv_kinematics__srv__SetLink_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_armpi_fpv_kinematics
...
/**
 * It allocates the memory for the array and calls
 * armpi_fpv_kinematics__srv__SetLink_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_armpi_fpv_kinematics
...
/**
 * It calls
 * armpi_fpv_kinematics__srv__SetLink_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * armpi_fpv_kinematics__srv__SetLink_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_armpi_fpv_kinematics
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * armpi_fpv_kinematics__srv__SetLink_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_armpi_fpv_kinematics
...
/**
 * It calls
 * armpi_fpv_kinematics__srv__SetLink_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_armpi_fpv_kinematics
...
/**
 * It allocates the memory for the array and calls
 * armpi_fpv_kinematics__srv__SetLink_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_armpi_fpv_kinematics
...
/**
 * It calls
 * armpi_fpv_kinematics__srv__SetLink_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ARMPI_FPV_KINEMATICS__SRV__DETAIL__SET_LINK__FUNCTIONS_H_
