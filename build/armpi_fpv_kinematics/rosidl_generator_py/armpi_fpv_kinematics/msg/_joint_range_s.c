...
bool armpi_fpv_kinematics__msg__joint_range__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("armpi_fpv_kinematics.msg._joint_range.JointRange", full_classname_dest, 48) == 0);
  }
  armpi_fpv_kinematics__msg__JointRange * ros_message = _ros_message;
  {  // min
...
{
  /* NOTE(esteve): Call constructor of JointRange */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("armpi_fpv_kinematics.msg._joint_range");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointRange");
