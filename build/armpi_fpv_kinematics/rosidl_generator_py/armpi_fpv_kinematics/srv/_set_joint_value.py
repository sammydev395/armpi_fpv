...
class Metaclass_SetJointValue_Event(type):
    """Metaclass of message 'SetJointValue_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_joint_value__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_joint_value__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_joint_value__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_joint_value__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_joint_value__event
...
class SetJointValue_Event(metaclass=Metaclass_SetJointValue_Event):
    """Message class 'SetJointValue_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<armpi_fpv_kinematics/SetJointValue_Request, 1>',
        'response': 'sequence<armpi_fpv_kinematics/SetJointValue_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['armpi_fpv_kinematics', 'srv'], 'SetJointValue_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['armpi_fpv_kinematics', 'srv'], 'SetJointValue_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from armpi_fpv_kinematics.srv import SetJointValue_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetJointValue_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetJointValue_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from armpi_fpv_kinematics.srv import SetJointValue_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetJointValue_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetJointValue_Response'"
...
class Metaclass_SetJointValue(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'armpi_fpv_kinematics.srv.SetJointValue')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from armpi_fpv_kinematics.srv import _set_joint_value
            ...
            if _set_joint_value.Metaclass_SetJointValue_Event._TYPE_SUPPORT is None:
                _set_joint_value.Metaclass_SetJointValue_Event.__import_type_support__()


class SetJointValue(metaclass=Metaclass_SetJointValue):
    from armpi_fpv_kinematics.srv._set_joint_value import SetJointValue_Request as Request
    from armpi_fpv_kinematics.srv._set_joint_value import SetJointValue_Response as Response
    from armpi_fpv_kinematics.srv._set_joint_value import SetJointValue_Event as Event
