...
static const _JointsRange_type_support_symbol_names_t _JointsRange_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, armpi_fpv_kinematics, msg, JointsRange)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, armpi_fpv_kinematics, msg, JointsRange)),
  }
};
...
{
  return &::armpi_fpv_kinematics::msg::rosidl_typesupport_cpp::JointsRange_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, armpi_fpv_kinematics, msg, JointsRange)() {
  return get_message_type_support_handle<armpi_fpv_kinematics::msg::JointsRange>();
}
