...
#include "armpi_fpv_kinematics/srv/detail/set_robot_pose__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = armpi_fpv_kinematics::srv::SetRobotPose_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const armpi_fpv_kinematics::srv::SetRobotPose_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<armpi_fpv_kinematics::srv::SetRobotPose_Request *>(
    untyped_ros_message);
...
{
  return &armpi_fpv_kinematics::srv::typesupport_fastrtps_cpp::_SetRobotPose_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = armpi_fpv_kinematics::srv::SetRobotPose_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const armpi_fpv_kinematics::srv::SetRobotPose_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<armpi_fpv_kinematics::srv::SetRobotPose_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &armpi_fpv_kinematics::srv::typesupport_fastrtps_cpp::_SetRobotPose_Response__handle;
}
...
// functions for armpi_fpv_kinematics::srv::SetRobotPose_Request already declared above

// functions for armpi_fpv_kinematics::srv::SetRobotPose_Response already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        armpi_fpv_kinematics::srv::typesupport_fastrtps_cpp::max_serialized_size_SetRobotPose_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        armpi_fpv_kinematics::srv::typesupport_fastrtps_cpp::max_serialized_size_SetRobotPose_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = armpi_fpv_kinematics::srv::SetRobotPose_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        armpi_fpv_kinematics::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SetRobotPose_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        armpi_fpv_kinematics::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SetRobotPose_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const armpi_fpv_kinematics::srv::SetRobotPose_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<armpi_fpv_kinematics::srv::SetRobotPose_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetRobotPose_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const armpi_fpv_kinematics::srv::SetRobotPose_Event *>(
...
static size_t _SetRobotPose_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetRobotPose_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetRobotPose_Event__callbacks = {
  "armpi_fpv_kinematics::srv",
  "SetRobotPose_Event",
...
static rosidl_message_type_support_t _SetRobotPose_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetRobotPose_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &armpi_fpv_kinematics::srv::typesupport_fastrtps_cpp::_SetRobotPose_Event__handle;
}
...
static const rosidl_service_type_support_t _SetRobotPose__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetRobotPose__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<armpi_fpv_kinematics::srv::SetRobotPose_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<armpi_fpv_kinematics::srv::SetRobotPose_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<armpi_fpv_kinematics::srv::SetRobotPose_Event>(),
...
{
  return &armpi_fpv_kinematics::srv::typesupport_fastrtps_cpp::_SetRobotPose__handle;
}
