...
bool hiwonder_servo_msgs__msg__servo_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hiwonder_servo_msgs.msg._servo_state.ServoState", full_classname_dest, 47) == 0);
  }
  hiwonder_servo_msgs__msg__ServoState * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // voltage
    ...
    assert(PyLong_Check(field));
    ros_message->voltage = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
PyObject * hiwonder_servo_msgs__msg__servo_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("hiwonder_servo_msgs.msg._servo_state");
