...
static const _CommandDurationList_type_support_symbol_names_t _CommandDurationList_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hiwonder_servo_msgs, msg, CommandDurationList)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hiwonder_servo_msgs, msg, CommandDurationList)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hiwonder_servo_msgs, msg, CommandDurationList)() {
  return &::hiwonder_servo_msgs::msg::rosidl_typesupport_c::CommandDurationList_message_type_support_handle;
}
