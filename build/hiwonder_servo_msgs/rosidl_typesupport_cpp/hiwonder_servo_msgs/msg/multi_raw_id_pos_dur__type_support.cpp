...
static const _MultiRawIdPosDur_type_support_symbol_names_t _MultiRawIdPosDur_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hiwonder_servo_msgs, msg, MultiRawIdPosDur)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hiwonder_servo_msgs, msg, MultiRawIdPosDur)),
  }
};
...
{
  return &::hiwonder_servo_msgs::msg::rosidl_typesupport_cpp::MultiRawIdPosDur_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, hiwonder_servo_msgs, msg, MultiRawIdPosDur)() {
  return get_message_type_support_handle<hiwonder_servo_msgs::msg::MultiRawIdPosDur>();
}
