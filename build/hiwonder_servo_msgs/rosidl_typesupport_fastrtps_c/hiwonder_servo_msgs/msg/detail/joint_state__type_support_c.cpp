...
#include "hiwonder_servo_msgs/msg/detail/joint_state__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // servo_ids, servo_temps
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // servo_ids, servo_temps
...
using _JointState__ros_msg_type = hiwonder_servo_msgs__msg__JointState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: servo_ids
  {
    size_t size = ros_message->servo_ids.size;
    auto array_ptr = ros_message->servo_ids.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serialize_array(array_ptr, size);
  }

  // Field name: servo_temps
  {
    size_t size = ros_message->servo_temps.size;
    auto array_ptr = ros_message->servo_temps.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serialize_array(array_ptr, size);
  }
  ...
  hiwonder_servo_msgs__msg__JointState * ros_message)
{
  ...
  // Field name: servo_ids
  {
    ...
    if (ros_message->servo_ids.data) {
      rosidl_runtime_c__int32__Sequence__fini(&ros_message->servo_ids);
    }
    if (!rosidl_runtime_c__int32__Sequence__init(&ros_message->servo_ids, size)) {
      fprintf(stderr, "failed to create array for field 'servo_ids'");
      return false;
    }
    auto array_ptr = ros_message->servo_ids.data;
  ...
  // Field name: servo_temps
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->servo_temps.data) {
      rosidl_runtime_c__int32__Sequence__fini(&ros_message->servo_temps);
    }
    if (!rosidl_runtime_c__int32__Sequence__init(&ros_message->servo_temps, size)) {
      fprintf(stderr, "failed to create array for field 'servo_temps'");
      return false;
    }
    auto array_ptr = ros_message->servo_temps.data;
    cdr.deserialize_array(array_ptr, size);
  ...
  size_t current_alignment)
{
  ...
  // Field name: servo_ids
  {
    size_t array_size = ros_message->servo_ids.size;
    auto array_ptr = ros_message->servo_ids.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    (void)array_ptr;
  ...
  // Field name: servo_temps
  {
    size_t array_size = ros_message->servo_temps.size;
    auto array_ptr = ros_message->servo_temps.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    (void)array_ptr;
  ...
  // Field name: goal_pos
  {
    size_t item_size = sizeof(ros_message->goal_pos);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hiwonder_servo_msgs__msg__JointState;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const hiwonder_servo_msgs__msg__JointState * ros_message = static_cast<const hiwonder_servo_msgs__msg__JointState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_hiwonder_servo_msgs__msg__JointState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  hiwonder_servo_msgs__msg__JointState * ros_message = static_cast<hiwonder_servo_msgs__msg__JointState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_hiwonder_servo_msgs__msg__JointState(cdr, ros_message);
}

static uint32_t _JointState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hiwonder_servo_msgs__msg__JointState(
...
static size_t _JointState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_hiwonder_servo_msgs__msg__JointState(
