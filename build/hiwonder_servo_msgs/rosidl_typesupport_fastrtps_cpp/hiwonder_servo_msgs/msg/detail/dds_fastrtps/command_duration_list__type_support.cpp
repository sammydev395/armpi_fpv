...
#include "hiwonder_servo_msgs/msg/detail/command_duration_list__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hiwonder_servo_msgs::msg::CommandDurationList & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hiwonder_servo_msgs::msg::CommandDurationList & ros_message)
{
  // Member: duration
  cdr >> ros_message.duration;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_hiwonder_servo_msgs
max_serialized_size_CommandDurationList(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hiwonder_servo_msgs::msg::CommandDurationList;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_hiwonder_servo_msgs
max_serialized_size_key_CommandDurationList(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const hiwonder_servo_msgs::msg::CommandDurationList *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hiwonder_servo_msgs::msg::CommandDurationList *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CommandDurationList__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const hiwonder_servo_msgs::msg::CommandDurationList *>(
...
static size_t _CommandDurationList__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CommandDurationList(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CommandDurationList__callbacks = {
...
static rosidl_message_type_support_t _CommandDurationList__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CommandDurationList__callbacks,
...
{
  return &hiwonder_servo_msgs::msg::typesupport_fastrtps_cpp::_CommandDurationList__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hiwonder_servo_msgs, msg, CommandDurationList)() {
  return &hiwonder_servo_msgs::msg::typesupport_fastrtps_cpp::_CommandDurationList__handle;
}
