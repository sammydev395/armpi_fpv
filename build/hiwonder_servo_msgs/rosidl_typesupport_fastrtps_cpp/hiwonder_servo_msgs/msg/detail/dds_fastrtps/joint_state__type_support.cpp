...
#include "hiwonder_servo_msgs/msg/detail/joint_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hiwonder_servo_msgs::msg::JointState & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: servo_ids
  {
    cdr << ros_message.servo_ids;
  }

  // Member: servo_temps
  {
    cdr << ros_message.servo_temps;
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hiwonder_servo_msgs::msg::JointState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: servo_ids
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.servo_ids[0]);
  ...
  // Member: servo_temps
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.servo_temps[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hiwonder_servo_msgs::msg::JointState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hiwonder_servo_msgs::msg::JointState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hiwonder_servo_msgs::msg::JointState *>(
    untyped_ros_message);
...
{
  return &hiwonder_servo_msgs::msg::typesupport_fastrtps_cpp::_JointState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hiwonder_servo_msgs, msg, JointState)() {
  return &hiwonder_servo_msgs::msg::typesupport_fastrtps_cpp::_JointState__handle;
}
