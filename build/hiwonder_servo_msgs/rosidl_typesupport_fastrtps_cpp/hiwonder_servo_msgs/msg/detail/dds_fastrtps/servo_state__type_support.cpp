...
#include "hiwonder_servo_msgs/msg/detail/servo_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hiwonder_servo_msgs::msg::ServoState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hiwonder_servo_msgs::msg::ServoState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hiwonder_servo_msgs::msg::ServoState *>(
    untyped_ros_message);
...
{
  return &hiwonder_servo_msgs::msg::typesupport_fastrtps_cpp::_ServoState__handle;
}
