...
hiwonder_servo_msgs__msg__MultiRawIdPosDur__init(hiwonder_servo_msgs__msg__MultiRawIdPosDur * msg)
{
  ...
  // id_pos_dur_list
  if (!hiwonder_servo_msgs__msg__RawIdPosDur__Sequence__init(&msg->id_pos_dur_list, 0)) {
    hiwonder_servo_msgs__msg__MultiRawIdPosDur__fini(msg);
    return false;
  }
  return true;
}
...
hiwonder_servo_msgs__msg__MultiRawIdPosDur__fini(hiwonder_servo_msgs__msg__MultiRawIdPosDur * msg)
{
  ...
  // id_pos_dur_list
  hiwonder_servo_msgs__msg__RawIdPosDur__Sequence__fini(&msg->id_pos_dur_list);
}
...
hiwonder_servo_msgs__msg__MultiRawIdPosDur__are_equal(const hiwonder_servo_msgs__msg__MultiRawIdPosDur * lhs, const hiwonder_servo_msgs__msg__MultiRawIdPosDur * rhs)
{
  ...
  // id_pos_dur_list
  if (!hiwonder_servo_msgs__msg__RawIdPosDur__Sequence__are_equal(
      &(lhs->id_pos_dur_list), &(rhs->id_pos_dur_list)))
  {
    return false;
  }
  return true;
  ...
  hiwonder_servo_msgs__msg__MultiRawIdPosDur * output)
{
  ...
  // id_pos_dur_list
  if (!hiwonder_servo_msgs__msg__RawIdPosDur__Sequence__copy(
      &(input->id_pos_dur_list), &(output->id_pos_dur_list)))
  {
    return false;
  }
  return true;
...
hiwonder_servo_msgs__msg__MultiRawIdPosDur__create(void)
{
  ...
  hiwonder_servo_msgs__msg__MultiRawIdPosDur * msg = (hiwonder_servo_msgs__msg__MultiRawIdPosDur *)allocator.allocate(sizeof(hiwonder_servo_msgs__msg__MultiRawIdPosDur), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hiwonder_servo_msgs__msg__MultiRawIdPosDur));
  bool success = hiwonder_servo_msgs__msg__MultiRawIdPosDur__init(msg);
  if (!success) {
...
hiwonder_servo_msgs__msg__MultiRawIdPosDur__Sequence__init(hiwonder_servo_msgs__msg__MultiRawIdPosDur__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hiwonder_servo_msgs__msg__MultiRawIdPosDur * data = NULL;

  if (size) {
    data = (hiwonder_servo_msgs__msg__MultiRawIdPosDur *)allocator.zero_allocate(size, sizeof(hiwonder_servo_msgs__msg__MultiRawIdPosDur), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hiwonder_servo_msgs__msg__MultiRawIdPosDur__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        hiwonder_servo_msgs__msg__MultiRawIdPosDur__fini(&data[i - 1]);
      }
...
hiwonder_servo_msgs__msg__MultiRawIdPosDur__Sequence__fini(hiwonder_servo_msgs__msg__MultiRawIdPosDur__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      hiwonder_servo_msgs__msg__MultiRawIdPosDur__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hiwonder_servo_msgs__msg__MultiRawIdPosDur__Sequence * array = (hiwonder_servo_msgs__msg__MultiRawIdPosDur__Sequence *)allocator.allocate(sizeof(hiwonder_servo_msgs__msg__MultiRawIdPosDur__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = hiwonder_servo_msgs__msg__MultiRawIdPosDur__Sequence__init(array, size);
  if (!success) {
...
hiwonder_servo_msgs__msg__MultiRawIdPosDur__Sequence__destroy(hiwonder_servo_msgs__msg__MultiRawIdPosDur__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    hiwonder_servo_msgs__msg__MultiRawIdPosDur__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
hiwonder_servo_msgs__msg__MultiRawIdPosDur__Sequence__are_equal(const hiwonder_servo_msgs__msg__MultiRawIdPosDur__Sequence * lhs, const hiwonder_servo_msgs__msg__MultiRawIdPosDur__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!hiwonder_servo_msgs__msg__MultiRawIdPosDur__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  hiwonder_servo_msgs__msg__MultiRawIdPosDur__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(hiwonder_servo_msgs__msg__MultiRawIdPosDur);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    hiwonder_servo_msgs__msg__MultiRawIdPosDur * data =
      (hiwonder_servo_msgs__msg__MultiRawIdPosDur *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!hiwonder_servo_msgs__msg__MultiRawIdPosDur__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          hiwonder_servo_msgs__msg__MultiRawIdPosDur__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!hiwonder_servo_msgs__msg__MultiRawIdPosDur__copy(
