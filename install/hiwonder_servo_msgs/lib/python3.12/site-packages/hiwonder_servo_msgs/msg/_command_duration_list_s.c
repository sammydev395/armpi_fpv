...
bool hiwonder_servo_msgs__msg__command_duration_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hiwonder_servo_msgs.msg._command_duration_list.CommandDurationList", full_classname_dest, 66) == 0);
  }
  hiwonder_servo_msgs__msg__CommandDurationList * ros_message = _ros_message;
  {  // duration
  ...
  {  // ids
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      uint16_t * dest = ros_message->ids.data;
...
{
  /* NOTE(esteve): Call constructor of CommandDurationList */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hiwonder_servo_msgs.msg._command_duration_list");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CommandDurationList");
  ...
  {  // ids
    ...
    if (ros_message->ids.size > 0) {
      ...
      uint16_t * src = &(ros_message->ids.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->ids.size * sizeof(uint16_t));
      assert(data != NULL);
