...
class HiwonderServoIO:
    ...
    def get_servo_range(self, servo_id):
        ...
        :param id:
        :return: 返回元祖 0： 低位  1： 高位(return tuple 0: low byte 1: high byte)
        '''
        count = 0
        msg = GetBusServoCmd()
        msg.id = servo_id
    ...
    def get_servo_vin_range(self, servo_id):
        ...
        读取舵机转动范围(read servo rotation range)
        :param id:
        :return: 返回元祖 0： 低位  1： 高位(tuple 0: low byte 1: high byte)
        '''
        count = 0
        msg = GetBusServoCmd()
        msg.id = servo_id
    ...
    def set_servo_temp_range(self, servo_id, m_temp):
        '''
        设置舵机最高温度报警(set the servo maximal temperature alarm)
        :param id:
        :param m_temp:
        :return:
        '''
    ...
    def enable_servo_torque(self, servo_id, torque=False):
        '''
        设置舵机转动力(set servo rotation force)
        :param id:
        :return:
        '''
        servo_state = BusServoState()
